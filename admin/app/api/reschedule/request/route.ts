...
export async function POST(req: Request) {
  ...
  if (!appt) return new Response(JSON.stringify({ error: "Not found" }), { status: 404 });
  ...
  broadcast("reschedule.request", { request: r, appointment: appt }, { doctorId: undefined, patientId: appt.patientId });
